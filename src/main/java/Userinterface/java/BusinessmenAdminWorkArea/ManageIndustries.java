...
import Main.java.Data.Industry;
 ...
 */
public class ManageIndustries extends javax.swing.JPanel {
    ...
    public ManageIndustries() {
        initComponents();
        Industry u = new Industry(Database.city,null,null,null);
        ObjectSet<Industry> industries = Database.db.get(u);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        for(Industry c :industries){
            model.addRow(new Object[]{c.getName(),c.getWebsite(),c.getAddress()});
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Industries");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 70, 220, 40));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 350, 50, -1));
        ...
        WebsiteTxtFld.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                WebsiteTxtFldActionPerformed(evt);
            }
        });
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 350, 70, -1));
        ...
        jPanel1.add(webButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 150, -1, -1));
        ...
        jPanel1.add(demoButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 150, 130, 60));

        jLabel2.setForeground(new java.awt.Color(0, 102, 204));
        jLabel2.setText("Address");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 450, -1, -1));
        ...
        jPanel1.add(AddressTxtFld, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 440, 190, 30));
...
//        Matcher m=p.matcher("https://google.com");
        ...
        Industry u = new Industry(Database.city,use,null,null);
        ObjectSet<Industry> industries = Database.db.get(u);
        if(!industries.isEmpty())
        {
            error.setText("Industry already created");
            return;
        }
        Industry sa= new Industry(Database.city,use,em,adr);
        sa.setLongitude(lon);
        sa.setLatitude(l);
        Database.db.set(sa);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.addRow(new Object[]{sa.getName(),sa.getWebsite(),sa.getAddress()});
        NameTxtFld.setText("");
    ...
    private void editButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editButton1MouseClicked
        ...
        String af = AddressTxtFld.getText();
        if(nf.isEmpty() || wf.isEmpty() || af.isEmpty())
        {
            return;
        }
        if(row<0)
        ...
        Industry c  = new Industry(Database.city,em,null,null);
        ObjectSet<Industry> result= Database.db.get(c);
        if(result.hasNext())
        {
            c = result.next();
    ...
    private void WebsiteTxtFldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_WebsiteTxtFldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_WebsiteTxtFldActionPerformed
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(row>=0){
           ...
           AddressTxtFld.setText(jTable1.getValueAt(row, 2).toString());
        }
        else
        {
          NameTxtFld.setText("");
    ...
    private void demobutton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_demobutton1MouseClicked
        ...
        String em= (String)jTable1.getValueAt(row,column);
        Industry c  = new Industry(Database.city,em,null,null);
        ObjectSet<Industry> result= Database.db.get(c); //ObjectSet is created. The set contains the result of
        // the 'get()'function, i.e Objects found in database.

        //Checks the Objectlist in database. Sees if the ObjectList is empty i.e any object is in the list or not. Every
