 ...
 */
public class ManageHotels extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 350, 50, -1));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, -1, 20));

        WebsiteTxtFld.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 102, 204)));
        jPanel1.add(WebsiteTxtFld, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 400, 190, 20));
        ...
        jPanel1.add(createButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 510, 140, -1));
        ...
        jPanel1.add(demoButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 140, -1, 60));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 410, 50, -1));
        ...
        jPanel1.add(webButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 210, -1, -1));

        jLabel9.setForeground(new java.awt.Color(0, 102, 204));
        jLabel9.setText("Image");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 450, -1, 20));
        ...
        jPanel1.add(ImgUpload, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 450, -1, 30));
        jPanel1.add(imageName, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 460, 170, 20));
        jPanel1.add(imageView, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 310, 480, 310));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-60, 0, 1600, 1610));
    ...
    private void createButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createButton1MouseClicked
        ...
        Hotel u = new Hotel(Database.city,use,null,null);
        ObjectSet<Hotel> hotels = Database.db.get(u);
        if(!hotels.isEmpty())
        {
            error.setText("Hotel already created");
            return;
        }
        ...
        Hotel sa= new Hotel(Database.city,use,em,imageName.getText());
        sa.setLatitude(l);
        sa.setLongitude(lon);
        Database.db.set(sa);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
