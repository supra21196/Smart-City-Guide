 ...
 */
public class ManageTouristPlaces extends javax.swing.JPanel {

    /**
     * Creates new form ManageUniversities
     */
    public ManageTouristPlaces() {
        initComponents();
        TouristSpot u = new TouristSpot(Database.city,null,null,null);
        ObjectSet<TouristSpot> spots = Database.db.get(u);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        for(TouristSpot c :spots){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Tourist Places");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 70, 260, 40));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 350, 50, -1));
        ...
        jPanel1.add(NameTxtFld, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 350, 190, -1));
        ...
        jPanel1.add(upload, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 450, -1, -1));

        jLabel7.setForeground(new java.awt.Color(0, 102, 204));
        jLabel7.setText("Website");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 400, -1, 20));

        WebsiteTxtFld.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 102, 204)));
        jPanel1.add(WebsiteTxtFld, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 400, 190, 20));

        jLabel8.setForeground(new java.awt.Color(0, 102, 204));
        jLabel8.setText("Image");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 450, -1, 20));
        ...
        jPanel1.add(editbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 510, -1, 50));
        ...
        jPanel1.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 510, -1, 50));

        error.setForeground(new java.awt.Color(255, 0, 0));
        jPanel1.add(error, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 320, 240, -1));
        jPanel1.add(imageName, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 460, 150, 20));
        ...
        jPanel1.add(demoButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 150, -1, 60));
        ...
        jLabel9.setText("Logitude");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 350, 50, -1));

        jLabel6.setForeground(new java.awt.Color(0, 102, 204));
        jLabel6.setText("Latitude");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 410, 50, -1));
        jPanel1.add(imageView, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 260, 360, 250));
    ...
    private void createButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createButton1MouseClicked
        ...
        TouristSpot u = new TouristSpot(Database.city,use,null,null);
        ObjectSet<TouristSpot> hotels = Database.db.get(u);
        if(!hotels.isEmpty())
        {
            error.setText("Tourist Spot already created");
            return;
        }
        if(imageName.getText().isEmpty())
        {
            error.setText("Image not selected");
            return;
        }
        TouristSpot sa= new TouristSpot(Database.city,use,em,imageName.getText());
        sa.setLatitude(l);
        sa.setLongitude(lon);
        Database.db.set(sa);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.addRow(new Object[]{sa.getName(),sa.getWebsite(),sa.getImage()});
        NameTxtFld.setText("");
