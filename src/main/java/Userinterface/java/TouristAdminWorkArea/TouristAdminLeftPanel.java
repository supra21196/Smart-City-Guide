...
import Userinterface.java.SystemAdminWorkArea.ManageTouristAdmin;
 ...
 */
public class TouristAdminLeftPanel extends javax.swing.JPanel {

    /**
     * Creates new form StudentAdminLeftPanel
     */
    private JPanel container;
    public TouristAdminLeftPanel(JPanel c) {
        initComponents();
        container=c;
    }
    ...
    private void initComponents() {
        ...
        add(LeftPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 270, -1));

        RightPanel.setBackground(new java.awt.Color(255, 255, 255));
        RightPanel.setPreferredSize(new java.awt.Dimension(1600, 1200));
        RightPanel.setLayout(new java.awt.CardLayout());
        add(RightPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 0, 1620, 1210));
    }// </editor-fold>//GEN-END:initComponents

    private void manage_servicesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_manage_servicesMouseClicked
        ManageTouristServices workarea = new ManageTouristServices(RightPanel);
