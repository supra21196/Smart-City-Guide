 ...
 */
package Userinterface.java.Businessmen;

import Main.java.Database.Database;
import Main.java.Login.Login;
import Userinterface.java.Tourist.*;
 ...
 */
public class BusinessmanDashboard extends javax.swing.JPanel {

    /**
     * Creates new form StudentDashboard
     */
    private JPanel container;
    public BusinessmanDashboard(JPanel c) {
        initComponents();
        container=c;
    }
    ...
    private void initComponents() {
        ...
        jPanel3.add(logout, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 30, -1, -1));
        ...
        industries.setBackground(new java.awt.Color(0, 204, 255));
        industries.setForeground(new java.awt.Color(255, 255, 255));
        industries.setText("     Smart Industries");
        industries.setOpaque(true);
        industries.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                industriesMouseClicked(evt);
            }
        });
        jPanel6.add(industries, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 158, 28));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon("/Users/sukhadapradhan/Smart City Full Project/icons8-factory-80.png")); // NOI18N
        jLabel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jLabel1.setOpaque(true);
        jPanel6.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 157, 120));
        ...
        jPanel8.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 870, 490));

        MainPanel.add(jPanel8, "card2");

        jPanel1.add(MainPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 84, -1, 740));
    ...
    private void industriesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_industriesMouseClicked
        Smart_Industries workarea = new Smart_Industries();
