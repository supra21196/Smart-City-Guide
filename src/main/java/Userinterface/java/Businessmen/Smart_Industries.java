 ...
 */
public class Smart_Industries extends javax.swing.JPanel {

    /**
     * Creates new form Smart_Banking
     */
    public Smart_Industries() {
        initComponents();
        Industry u = new Industry(Database.city,null,null,null);
        ObjectSet<Industry> industry = Database.db.get(u);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        for(Industry c :industry){
    ...
    private void initComponents() {
        ...
        searchButton = new GUIComponents.RoundedPanel();
        ...
        jLabel1.setText("View Industries");
        ...
        searchButton1.setBackground(new java.awt.Color(0, 0, 0));
        searchButton1.setFont(new java.awt.Font("Lucida Grande", 1, 16)); // NOI18N
    ...
    private void searchButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchButton1MouseClicked
        ...
        for(Industry i:industry)
        {
            ...
            {
                ((DefaultTableModel)jTable1.getModel()).addRow(new Object[]{i.getName(),i.getWebsite(),i.getAddress()});
            }
        }
    ...
    private GUIComponents.RoundedPanel searchButton;
