 ...
 */
public class ManageFood_Outlets extends javax.swing.JPanel {

    /**
     * Creates new form ManageUniversities
     */
    public ManageFood_Outlets() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Food Outlets");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 70, 250, 40));
        ...
        jPanel1.add(webButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 230, 170, -1));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 2010, 1470));
    ...
    private void createButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createButton1MouseClicked
        ...
        Food_Outlet u = new Food_Outlet(Database.city,use,null);
        ObjectSet<Food_Outlet> libraries = Database.db.get(u);
        if(!libraries.isEmpty())
        {
            error.setText("Food Outlet already created");
            return;
        }
        Food_Outlet sa= new Food_Outlet(Database.city,use,em);
        sa.setLatitude(l);
        sa.setLongitude(lon);
        Database.db.set(sa);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
