 ...
 */
public class ManageJobs extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 350, 60, -1));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 400, -1, 20));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 410, 60, -1));
        ...
        jPanel1.add(webButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 230, 140, -1));
    ...
    private void createButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createButton1MouseClicked
        ...
        Job u = new Job(Database.city,use,null);
        ObjectSet<Job> libraries = Database.db.get(u);
        ...
        Job sa= new Job(Database.city,use,em);
        sa.setLatitude(l);
        sa.setLongitude(lon);
        Database.db.set(sa);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
