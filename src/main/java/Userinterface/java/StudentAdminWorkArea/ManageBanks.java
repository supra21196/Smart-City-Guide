 ...
 */
public class ManageBanks extends javax.swing.JPanel {
    ...
    public ManageBanks() {
        initComponents();
        Banks u = new Banks(Database.city,null,null);
        ObjectSet<Banks> libraries = Database.db.get(u);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        for(Banks c :libraries){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Banks");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 70, 170, 40));
        ...
        jPanel1.add(createButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 500, 140, 60));
        ...
        jPanel1.add(editbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 500, -1, 60));
        ...
        jPanel1.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 500, -1, 60));
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1700, 1230));
    ...
    private void createButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createButton1MouseClicked
        ...
        Banks u = new Banks(Database.city,use,null);
        ObjectSet<Banks> banks = Database.db.get(u);
        if(!banks.isEmpty())
        {
            error.setText("Library already created");
            return;
        }
        Banks sa= new Banks(Database.city,use,em);
        sa.setLatitude(l);
        sa.setLongitude(lon);
        Database.db.set(sa);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
    ...
    private void editButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editButton1MouseClicked
        ...
        Banks c  = new Banks(Database.city,em,null);
        ObjectSet<Banks> result= Database.db.get(c);
        if(result.hasNext())
        {
            c = result.next();
