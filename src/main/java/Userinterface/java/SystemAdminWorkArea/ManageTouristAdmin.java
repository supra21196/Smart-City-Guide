...
import Main.java.Roles.TouristAdmin;
 ...
 */
public class ManageTouristAdmin extends javax.swing.JPanel {

    /**
     * Creates new form SystemAdminWorkArea
     */
    public ManageTouristAdmin() {
        initComponents();
        ObjectSet<TouristAdmin> touristAdmins = Database.db.get(TouristAdmin.class);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        for(TouristAdmin c :touristAdmins){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Tourist Admin");
        ...
        jPanel2.add(editButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 520, -1, 50));
        ...
        jPanel2.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 520, -1, 50));
    ...
    private void createButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_createButton1MouseClicked
        ...
        TouristAdmin sa= new TouristAdmin(use,em,p1);
        Database.db.set(sa);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
    ...
    private void editButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editButton1MouseClicked
        ...
        TouristAdmin c  = new TouristAdmin(null,em,null);
        ObjectSet<TouristAdmin> result= Database.db.get(c);
        if(result.hasNext())
        {
            c = result.next();
